...
int main()
{
	...
	const char *key = "stasd";

	result = reinterpret_cast<char**>(binsearchx(&key, arr, sizeof(arr)/sizeof(arr[0]), sizeof(char *), reinterpret_cast<int (*)(const void*, const void*)>(char_cmp)));
